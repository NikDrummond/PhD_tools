...
def plot_single_ellipse(ax, center, major, minor, angle, theta, center_point=(0,0), plot_center = False, flip_axes=False, color='blue'):
    """
    ...
    # Plot
    ax.plot(x_final, y_final, color=color, lw=2)
    if plot_center:
