...
def A4_figure(A4_width_cm = A4_width_cm, A4_height_cm = A4_height_cm,margin_top = margin_top, margin_bottom = margin_bottom, margin_left = margin_left, margin_right = margin_right):
